...
const professorform = document.querySelector('#professorform');
...
const professors_form = document.querySelector('#professors');
// show the DIV if it is hidden
professors_form.style.display = 'block';


// event handler
professorform.onsubmit = (e) => {
    ...
    .then( (data) => {
        professors_form.style.display = 'none';
